...
const FROM = process.env.EMAIL_FROM ?? "Vayora <onboarding@resend.dev>";
...
export async function sendPasswordResetEmail(email: string, resetUrl: string) {
  ...
  await resend.emails.send({
    from: FROM,
    to: email,
    subject: "Vayora — Нууц үг сэргээх",
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px;">
        <h2 style="color: #0f7a4f;">Нууц үг сэргээх хүсэлт</h2>
        <p>Та Vayora дээрх нууц үгээ сэргээх хүсэлт илгээсэн байна. Доорх товч дээр дарж шинэ нууц үгээ тохируулна уу.</p>
